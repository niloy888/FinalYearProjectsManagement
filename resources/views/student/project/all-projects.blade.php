...
--}}
    ...
    <form action="{{route('final-project')}}" method="post" class="d-none d-sm-inline-block form-inline mr-auto  my-2 my-md-0 mw-100 navbar-search">
        @csrf
        <div class="input-group">
            <input type="text" id="project_name" name="project_name" class="form-control  border-0 small" placeholder="Project name..." aria-label="Search" aria-describedby="basic-addon2">
